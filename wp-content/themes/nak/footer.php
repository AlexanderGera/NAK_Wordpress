  ...
  style="background-image: url('<?php echo esc_url(get_field('banner_search_bottom')); ?>');">
  ...
  <footer class="footer">
      <div class="footer__logo-holder_wrapper">
          <div class="footer__logo-holder">
              ...
              <span class="footer__logo_title header__logo_title"><?php echo get_field('seit_name'); ?></span>
          </div>
